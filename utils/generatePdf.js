  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc
        ...
        .font(textFont)
        .fontSize(30)
        .text("Mobile Shop Mirzewala", 40, 40, {
          lineGap: 6,
          characterSpacing: 2,
        });
      ...
      doc
        .text(
          `Invoice No: ${billData.invoiceNo || billData.serial || ""}`,
          350,
          infoY
        )
        .text(`Date: ${formatDate(billData.date)}`, 350, infoY + 18);
      ...
      doc.rect(40, tableTop, 515, rowHeight).fill(tableHeaderBg);
      ...
      doc.rect(40, currentY, 515, rowHeight).fill(footerBg);
      doc.rect(40, currentY, 515, rowHeight).stroke();
      ...
      doc
        ...
        .fontSize(12)
        .text(
          `Invoice Amount in Words: ${billData.amountInWords || ""}`,
          40,
          currentY
        );
